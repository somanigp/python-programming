...
question_data = [
    ...
    {"text": "In West Virginia, USA, if you accidentally hit an animal with your car, you are free to take "
             "it home to eat.", "answer": "True"},  # For newline hit enter, and it will do everything accordingly.
    ...
    {"text": "Google was originally called 'Backrub'.", "answer": "True"},  # Click Bulb and save to dictionary
    {"text": "Buzz Aldrin's mother's maiden name was 'Moon'.", "answer": "True"},
    {"text": "No piece of square dry paper can be folded in half more than 7 times.", "answer": "False"},
    {"text": "A few ounces of chocolate can to kill a small dog.", "answer": "True"}
]

# Code -> Reformat Code, keep re-formatting to get correct format
